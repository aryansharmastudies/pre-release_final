...
def Serving(Tills, NoOfTills, BuyerQ, QLength, Stats):
  ...
  # print("current free till:", TillFree)
  # # this can return a free till OR not.
  # print("current queue length", QLength)
  # print(f"buyer queue: {BuyerQ[0].BuyerID} {BuyerQ[1].BuyerID} {BuyerQ[2].BuyerID}")
